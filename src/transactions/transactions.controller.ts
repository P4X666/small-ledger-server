...
export class TransactionsController {
  ...
  @Post()
  async create(@Body() createTransactionDto: CreateTransactionDto, @GetCurrentUser() user: User): Promise<Transaction> {
  ...
  @Get(':id')
  async findOne(@Param('id') id: string, @GetCurrentUser() user: User): Promise<Transaction> {
    return this.transactionsService.findOne(+id, user.id);
  }

  @Put(':id')
  async update(@Param('id') id: string, @Body() updateTransactionDto: UpdateTransactionDto, @GetCurrentUser() user: User): Promise<Transaction> {
  ...
  @Get('statistics')
  async getStatistics(@GetCurrentUser() user: User): Promise<TransactionStatisticsDto> {
